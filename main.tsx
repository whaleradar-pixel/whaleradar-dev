...
import {
  ...
  MessageCircle, Calendar, AlertTriangle, Key, Copy, UserCheck
} from 'lucide-react';
                    ...
                    <div className="flex gap-2">
                      <button
                        onClick={async () => {
                          ...
                          // Store impersonation token in localStorage (shared between tabs) and open app in new tab
                          ...
                          localStorage.setItem('wr_impersonation', JSON.stringify(impersonationData));
